...
public class DrawHeart extends GraphicsProgram{	
	...
	public void run()
	{
		...
		m_leftPoint.setLocation( m_centerXPosition - m_raduis, m_centerOfSquareY );
		...
		GArc leftHump = new GArc(m_centerXPosition - m_side, m_centerOfSquareY+m_circleDiameter,
